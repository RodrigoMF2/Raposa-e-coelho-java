...
public class Raposa extends Animal{
     ...
     */
    public Raposa(boolean randomAge, Campo field, Localizacao location) {
        age = 0;
        alive = true;
        this.field = field;
     ...
     *
     * @param field      The field currently occupied.
     * @param newRaposas A list to return newly born foxes.
     */
    public void hunt(List<Raposa> newRaposas) {
        incrementAge();
        incrementHunger();
        if (alive) {
            giveBirth(newRaposas);
     ...
     * @param newRaposas A list to return newly born foxes.
     */
    private void giveBirth(List<Raposa> newRaposas) {
